 ...
 */
// Edit lines  379/380 and 401/402 to match YOUR ESP module
/*
===========================================================
==========          CONSTANTS                    ==========
===========================================================
...
int ESP8266_JoinAccessPoint(const char* ssid, const char* password){
  ...
  SearchStart("ok");
  while(try){
    sprintf((char*)TXBuffer, "AT+CWJAP_DEF=\"%s\",\"%s\"\r\n", ssid, password);
    ESP8266SendCommand((const char*)TXBuffer);
